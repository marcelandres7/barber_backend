...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'authentication.staff.success.listener' => 'getAuthentication_Staff_Success_ListenerService',
            'authentication.success.listener' => 'getAuthentication_Success_ListenerService',
            ...
            'entity.helper' => 'getEntity_HelperService',
            'event_dispatcher' => 'getEventDispatcherService',
            'exception.listener' => 'getException_ListenerService',
            ...
            'message.helper' => 'getMessage_HelperService',
            ...
            'redeem.helper' => 'getRedeem_HelperService',
            ...
            'security.authentication.session_strategy.backend' => 'getSecurity_Authentication_SessionStrategy_BackendService',
            ...
            'security.user.provider.concrete.staff_db_provider' => 'getSecurity_User_Provider_Concrete_StaffDbProviderService',
            ...
            'user.helper' => 'getUser_HelperService',
            'user.role.handler' => 'getUser_Role_HandlerService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.frontend' => 'security.user_checker.backend',
    ...
    /*
     * Gets the public 'authentication.staff.success.listener' shared service.
     *
     * @return \AppBundle\EventListener\AuthenticationStaffEventListener
     */
    protected function getAuthentication_Staff_Success_ListenerService()
    {
        return $this->services['authentication.staff.success.listener'] = new \AppBundle\EventListener\AuthenticationStaffEventListener($this->get('router'), $this->get('security.context'), $this);
    }

    /*
     * Gets the public 'authentication.success.listener' shared service.
     *
     * @return \AppBundle\EventListener\AuthenticationEventListener
     */
    protected function getAuthentication_Success_ListenerService()
    {
        return $this->services['authentication.success.listener'] = new \AppBundle\EventListener\AuthenticationEventListener($this->get('router'), $this->get('security.context'), $this);
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'barber_db2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ab59dddabf73afa733cefc6ba1d58cca2aff1e082b3960113a4e0b8f17ba8076');
    ...
    /*
     * Gets the public 'entity.helper' shared service.
     *
     * @return \AppBundle\Helper\EntityHelper
     */
    protected function getEntity_HelperService()
    {
        return $this->services['entity.helper'] = new \AppBundle\Helper\EntityHelper();
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'exception.listener', 1 => 'onKernelException'), 0);
        $instance->addListenerService('kernel.request', array(0 => 'user.role.handler', 1 => 'onKernelRequest'), 0);
    ...
    /*
     * Gets the public 'exception.listener' shared service.
     *
     * @return \AppBundle\EventListener\ExceptionListener
     */
    protected function getException_ListenerService()
    {
        return $this->services['exception.listener'] = new \AppBundle\EventListener\ExceptionListener($this->get('kernel'), $this);
    }
    ...
    /*
     * Gets the public 'message.helper' shared service.
     *
     * @return \AppBundle\Helper\MessageHelper
     */
    protected function getMessage_HelperService()
    {
        return $this->services['message.helper'] = new \AppBundle\Helper\MessageHelper($this->get('doctrine.orm.default_entity_manager'), $this->targetDirs[2], 'prod');
    }
    ...
    /*
     * Gets the public 'redeem.helper' shared service.
     *
     * @return \AppBundle\Helper\RedeemHelper
     */
    protected function getRedeem_HelperService()
    {
        return $this->services['redeem.helper'] = new \AppBundle\Helper\RedeemHelper($this->get('doctrine.orm.default_entity_manager'), 'LOYALTY_GAMA', 3, 'SHERWIN WILLIAMS PROMOS: Ocurrio un error al realizar el canje, por favor comunicate al 2429-2945');
    }
    ...
    protected function getSecurity_Authentication_GuardHandlerService()
    {
        ...
        $instance->setSessionAuthenticationStrategy($this->get('security.authentication.session_strategy.backend'));

        return $instance;
    }

    /*
     * Gets the public 'security.authentication.session_strategy.backend' shared service.
     *
     * @return \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy
     */
    protected function getSecurity_Authentication_SessionStrategy_BackendService()
    {
        return $this->services['security.authentication.session_strategy.backend'] = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => true, 2 => 5000)), 'AppBundle\\Entity\\Staff' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.backend' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/'), 'security.firewall.map.context.frontend' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/staff/'))), $this->get('event_dispatcher'));
    }

    /*
     * Gets the public 'security.firewall.map.context.backend' shared service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_BackendService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($d, $e, array(), $b);
        $g->setOptions(array('login_path' => 'backend_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/backend/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/backend/logout'));
        $h->addHandler($this->get('security.logout.handler.csrf_token_clearing'));
        $h->addHandler($this->get('security.logout.handler.session'));

        return $this->services['security.firewall.map.context.backend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.our_db_provider'), 1 => $this->get('security.user.provider.concrete.staff_db_provider')), 'backend', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy.backend'), $e, 'backend', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('authentication.success.listener'), array('always_use_default_target_path' => true, 'default_target_path' => 'backend_main', 'login_path' => 'backend_login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'backend'), $g, array('check_path' => 'backend_login', 'require_previous_session' => false, 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '627a6acc6cbc26.56633539', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'backend', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($d, $e, 'backend_login', false), NULL, NULL, $b, false), $h);
    }
    ...
    /*
     * Gets the public 'security.firewall.map.context.frontend' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_FrontendService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($d, $e, array(), $b);
        $g->setOptions(array('login_path' => '/staff/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/staff/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/staff/logout'));
        $h->addHandler($this->get('security.logout.handler.csrf_token_clearing'));
        $h->addHandler($this->get('security.logout.handler.session'));

        return $this->services['security.firewall.map.context.frontend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.our_db_provider'), 1 => $this->get('security.user.provider.concrete.staff_db_provider')), 'frontend', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy.backend'), $e, 'frontend', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('authentication.staff.success.listener'), array('always_use_default_target_path' => true, 'default_target_path' => '/staff/login', 'login_path' => '/staff/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'frontend'), $g, array('check_path' => '/staff/login', 'require_previous_session' => false, 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '627a6acc6cbc26.56633539', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'frontend', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($d, $e, '/staff/login', false), NULL, NULL, $b, false), $h);
    }
    ...
    /*
     * Gets the public 'security.user_checker.backend' shared service.
     *
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('name' => 'page_factory_v3', 'cookie_httponly' => true, 'gc_maxlifetime' => 600, 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('message_max_length', 157);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('570e2daaf563a6f8e4f3c45778c36467371eb901');
    }

    /*
     * Gets the public 'user.helper' shared service.
     *
     * @return \AppBundle\Helper\UserHelper
     */
    protected function getUser_HelperService()
    {
        return $this->services['user.helper'] = new \AppBundle\Helper\UserHelper($this->get('security.password_encoder'));
    }

    /*
     * Gets the public 'user.role.handler' shared service.
     *
     * @return \AppBundle\Handler\UserRoleHandler
     */
    protected function getUser_Role_HandlerService()
    {
        return $this->services['user.role.handler'] = new \AppBundle\Handler\UserRoleHandler($this->get('router'), $this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'), $this->get('session'), 'You dont have permissions.');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/user/logout'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/checkmp'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/main'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/sms-incoming'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/sale/not-assigned'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/staff'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/registerPending/edit'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/registerPending'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/staff/login'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/staff/getPrize'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/staff/'), array(0 => 'ROLE_ADMINISTRADOR'), NULL);
    ...
    {
        $a = $this->get('security.user_checker.backend');
        $b = $this->get('security.encoder_factory');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.our_db_provider'), $a, 'backend', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('627a6acc6cbc26.56633539'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.staff_db_provider'), $a, 'frontend', $b, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('627a6acc6cbc26.56633539')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('frontend', '/staff/logout', 'logout', '_csrf_token', NULL);
    ...
    /*
     * Gets the private 'security.user.provider.concrete.staff_db_provider' shared service.
     *
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider
     */
    protected function getSecurity_User_Provider_Concrete_StaffDbProviderService()
    {
        return $this->services['security.user.provider.concrete.staff_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Staff', 'phoneMain', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mail_to' => 'jelvira@ebclosion.com',
            'secret' => '570e2daaf563a6f8e4f3c45778c36467371eb901',
            'invalid_user' => 'The username or password entered is not correct.',
            'invalid_module' => 'You dont have permissions.',
            'requerido' => 'This field is required',
            'invalido' => 'El valor es inv&aacute;lido',
            'correo' => 'Debe escribir un correo electronico',
            'fecha' => 'Debe escribir una fecha v&aacute;lida',
            'seleccion' => 'Debe seleccionar un valor',
            'error_form' => 'An error occurred while validating the form data.',
            'error_puesto_trabajo' => 'El puesto de trabajo ingresado no esta permitido',
            'exito' => 'Your registration was saved successfully.',
            'exito_revisado' => 'Tu registro fue guardado con &eacute;xito y tus datos seran validados. En 48 horas te enviaremos un mensaje de texto a tu n&uacute;mero de tel&eacute;fono registrado, para informar si tu inscripcion ha sido confirmada.',
            'exito_mensaje_contacto' => 'Tu mensaje se ha enviado correctamente, pronto nos comunicaremos contigo.',
            'error_mensaje_contacto' => 'Ocurrio un error al enviar tu mensaje, por favor intentalo nuevamente.',
            'exito_actualizar' => 'Registration successfully updated.',
            'exito_eliminar' => 'Registration was successfully deleted.',
            'exito_inactivar' => 'Registration was successfully inactivated.',
            'exito_factura_pendiente' => 'Se han guardado con &eacute;xito <strong>%s</strong> factura(s), recibiras una notificaci&oacute;n cuando sean aprobadas o rechazadas.',
            'error' => 'Ocurrió un error al guardar los datos, por favor intentalo de nuevo.',
            'error_editar' => 'An error occurred while obtaining the data, please try again.',
            'error_eliminar' => 'An error occurred while deleting the record.',
            'error_inactivar' => 'An error occurred while inactivating the registry.',
            'error_existente' => 'There was an error saving the record, it already exists.',
            'error_cupon_no_existe' => 'Ocurrió un error, favor de validar el cupon no existe.',
            'error_cupon_usado' => 'Ocurrió un error, el cupon ya fue usado.',
            'pos_error_msg' => 'Este tipo de usuario puede tener &uacute;nicamente un punto de venta asociado, elimine el actual antes de agregar uno nuevo.',
            'no_pos_error_msg' => 'No se encontro ningun punto de venta asociado a este cliente, por favor agregue uno para poder validar sus facturas.',
            'usuario_existente' => 'El usuario existe en la base de datos, escriba uno diferente.',
            'usuario_existente_dpi_nit' => 'El DPI y/o NIT ingresado ya existe en la base de datos, por favor ingrese uno diferente.',
            'usuario_existente_rechazarlo' => 'El usuario existe en la base de datos, por favor rechazarlo.',
            'factura_existente_rechazarlo' => 'La factura asociada ya fue registrada en la base de datos, por favor rechazarlo.',
            'demasiados_caracteres' => 'El campo %s debe ser menor a %s caracteres.',
            'exito_codigo' => 'Se guardó con éxito el código.',
            'error_sale_upload' => 'Ocurrió un error guardando datos del archivo',
            'registro_pendiente_confirmado' => 'SHERWIN WILLIAMS PROMOS: Tu inscripcion ha sido confirmada. Recuerda reportar tus facturas para acumular puntos.',
            'registro_pendiente_rechazado' => 'SHERWIN WILLIAMS PROMOS: Tu inscripcion no pudo confirmarse. Para mas informacion llama al 1234-5678',
            'factura_pendiente_rechazada' => 'SHERWIN WILLIAMS PROMOS: Una de tus facturas ingresadas no pudo confirmarse, ingresa a tu cuenta para obtener detalles. Para mas informacion llama al 1234-5678',
            'registro_sms_existente' => 'SHERWIN WILLIAMS PROMOS: Este numero de telefono ya se encuentra inscrito en el programa de lealtad.',
            'sms_exito_revisado' => 'SHERWIN WILLIAMS PROMOS: Tus datos seran validados. En 48 horas te enviaremos un mensaje de texto a tu numero de telefono registrado, para informar si tu inscripcion ha sido confirmada.',
            'extension_error_logo' => 'La extensi&oacute;n utilizada en la im&aacute;gen de perfil es inv&aacute;lida. Por favor seleccione JPG o PNG e intente nuevamente.',
            'extension_error_invoice' => 'La extensi&oacute;n utilizada en una o m&aacute;s im&aacute;gen seleccionadas es inv&aacute;lida. Por favor seleccione JPG o PNG e intente nuevamente.',
            'reward_criteria_error' => 'Ocurrio un error al obtener el criterio de recompenza de unos de los productos, por favor comuniquese con soporte t&eacute;cnico.',
            'error_recarga' => 'Ocurrio un error al enviar la recarga.',
            'dpi_repetido' => 'El DPI ingresado ya existe en la base de datos, por favor ingresa uno diferente.',
            'telefono_repetido' => 'El n&uacute;mero de tel&eacute;fono ingresado ya existe en la base de datos, por favor ingresa uno diferente.',
            'sms_puntos_ganados' => 'SHERWIN WILLIAMS PROMOS: Por ingresar la factura No. [FACTURA] has acumulado Q. [PUNTOS] tu saldo total disponible es Q. [TOTAL_PUNTOS].',
            'sms_puntos_promo_ganados' => 'SHERWIN WILLIAMS PROMOS: Ganaste! Q. [PUNTOS] promocionales adicionales con la factura registrada No. [INVOICE] !.',
            'exito_envio' => 'Tu mensaje se esta enviando',
            'exito_envios' => 'Tus mensajes se estan enviando',
            'exito_envio_programado' => 'Tu mensaje ha sido programado',
            'error_desactivar' => 'Ocurrió un error al desactivar el registro.',
            'exito_desactivar' => 'Se desactivó con éxito el registro.',
            'agregados_reversa' => 'Se agregaron %s registros en el módulo de reversas, se requiere de su atención para procesarlos.',
            'add_reverse' => 'Se agregaron %d registros en el módulo de reversas, se requiere de su atención para procesarlos.',
            'exito_reverse' => 'Se ejecuto con éxito la reversa.',
            'error_distributor_exist' => 'El Distribuidor que intenta registrar, ya existe.',
            'error_category_exist' => 'La categoría que intenta registrar, ya existe.',
            'error_brand_exist' => 'La marca que intenta registrar, ya existe.',
            'error_banner_exist' => 'El banner que intenta registrar, ya existe.',
            'error_product_type_exist' => 'El tipo de producto que intenta registrar, ya existe.',
            'error_product_exist' => 'El producto que intenta registrar, ya existe.',
            'error_promotion_exist' => 'La promoción que intenta registrar, ya existe.',
            'exito_canje_promo' => 'Se registró el canje con éxito.',
            'error_canje_promo' => 'El código que intenta canjear, ya fue canjeado.',
            'error_canje_promo_cero' => 'Debe colocar una cantidad mayor a cero en al menos una promoción.',
            'number_of_rows' => 10,
            'number_of_rows_large' => 100,
            'number_of_rows_small' => 5,
            'upload_files' => 'uploads/',
            'upload_invoice' => 'uploads/client_invoice/',
            'profile_image' => 'uploads/clients/profile_image/',
            'invoice_image' => 'uploads/clients/invoice_image/',
            'sale_upload_from_web' => 'uploads/sale',
            'news_image_path' => 'images/news',
            'promotion_image_path' => 'uploads/promotions',
            'prize_image_path' => 'images/prize',
            'sale_upload_folder' => ($this->targetDirs[2].'/../web/uploads/sale'),
            'point_of_sale_upload_from_web' => 'uploads/point_of_sale',
            'point_of_sale_upload_folder' => ($this->targetDirs[2].'/../web/uploads/point_of_sale'),
            'staff_upload_folder' => ($this->targetDirs[2].'/../web/uploads/staff'),
            'goal_upload_folder' => ($this->targetDirs[2].'/../web/uploads/goal'),
            'ws_log_file' => '../app/logs/ws_log_file.txt',
            'report_invoice_path' => 'uploads/invoices/',
            'category_image_path' => 'uploads/category',
            'brand_image_path' => 'uploads/brand',
            'banner_image_path' => 'uploads/banner',
            'product_image_path' => 'uploads/product',
            'conection_recharge_account' => 3,
            'conection_bag_name' => 'LOYALTY_GAMA',
            'proximo_canje' => 'SHERWIN WILLIAMS PROMOS: Los canjes no estan habilitados, sigue acumulando Q. y espera para obtener los mejores beneficios.',
            'error_canje' => 'Ocurrio un error al realizar el canje, por favor intentalo de nuevo.',
            'error_canje_sms' => 'SHERWIN WILLIAMS PROMOS: Ocurrio un error al realizar el canje, por favor comunicate al 2429-2945',
            'error_puntos_sms' => 'SHERWIN WILLIAMS PROMOS: Tienes [CREDITS] quetzales disponibles. No cuentas con el saldo suficiente para canjear este premio. Mas informacion al 1-801-426-551',
            'error_codigo_rest' => 'SHERWIN WILLIAMS PROMOS: El codigo enviado no es valido.',
            'exito_canje' => 'Has canjeado Q. [CREDITS] por [PREMIO] Tu nuevo saldo es de Q. [SALDO].',
            'exito_canje_codigo' => 'Has canjeado Q. [CREDITS] por [PREMIO] Tu nuevo saldo es de Q. [SALDO], Tu codigo de canje es [CODE].',
            'url_entrance' => 'http://dev.ebfuture.net/loyalty_cempro/web/api/entrance.php',
            'api_token' => 'MjQ0OTIyMzk5OQ',
            'message_max_length' => 157,
            'goal_message' => 'SHERWIN WILLIAMS PROMOS: Ha ganado el premio: [PRIZE]',
            'goal_reached' => 'SHERWIN WILLIAMS PROMOS: Felicidades ha alcanzado la meta',
            'goal_points_message' => 'Felicidades CEMPRO te regala Q. [POINTS]',
            'promo_won' => 'Felicidades, has ganado la promocion [PROMO] !',
            'promo_specific_prize' => 'Felicidades CEMPRO te regala [PRIZE]',
            'promo_points_message' => 'Felicidades CEMPRO te regala Q. [POINTS]',
            'promo_pre_winners_max' => 10,
            'locale' => 'en',
            ...
            'kernel.secret' => '570e2daaf563a6f8e4f3c45778c36467371eb901',
