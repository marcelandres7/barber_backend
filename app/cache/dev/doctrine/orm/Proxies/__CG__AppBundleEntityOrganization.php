...
class Organization extends \AppBundle\Entity\Organization implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'organizationId', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'createdBy', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'updatedBy', '' . "\0" . 'AppBundle\\Entity\\Organization' . "\0" . 'status');
        }
    ...
    public function getOrganizationId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getOrganizationId();
        }
