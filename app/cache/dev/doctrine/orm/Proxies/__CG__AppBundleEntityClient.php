...
class Client extends \AppBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'clientId', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'phone', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'avatar', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'register', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'promotion');
        }
    ...
    public function setRegister($register)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRegister', array($register));
    ...
    public function getRegister()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRegister', array());
