	  ...
	  $(document).ready(function()
	  {
	  	  ...
	  	  console.log("hola",am.getContainer());	  	  	  	  
      ...
      function addAssets(editor)
      {
	      
	      var am = editor.AssetManager;
	      $.ajax({
			  url: global_asset_get,
			  type: 'post',
			  data: {},
			  beforeSend: function () {
	  ...
	  function registerAssetManually(path)
	  {
		  var am = editor.AssetManager;
	      $.ajax({
			   url: global_asset_add,
			   type: 'post',
			   data: {
				  path:path
			   },
      ...
      editor  = grapesjs.init({
        ...
        assetManager: {
          /*embedAsBase64: 1,*/
          assets: images,
          upload: global_upload_path,
          autoAdd: 1,
          handleAdd: function(imageAdded)
          {
		  	  registerAssetManually(imageAdded);
          }
        },
        storageManager: { 
		    type: 'remote',
		    stepsBeforeSave: 3,
		    urlStore: global_storage_save,
		    urlLoad: global_storage_load
	    },
          ...
          'gjs-preset-webpage': {
            ...
            customStyleManager: [{
              ...
              properties:[{
                ...
                name: 'Dimension',
                open: false,
                buildProps: ['width', 'max-width', 'min-width','flex-width', 'height', 'max-height', 'min-height', 'margin', 'padding'],
                properties: [{
                  id: 'flex-width',
                  type: 'integer',
                  name: 'Width',
      ...
      editor.Panels.addButton('options',[{ 
	      ...
	      attributes: { title: 'Save Template', id:'start_store' } }, 
	  ]);
	  editor.Panels.addButton('options',[{ 
	      id: 'spin', 
	      className: 'fa fa-spin fa-spinner icon-blank hide_icon', 	      
	      attributes: { id:'start_spinner' } }, 
	  ]);
	  editor.on('asset:remove', (a) => {
	  		removeAsset(a);
	  });
